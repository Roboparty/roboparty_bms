...
/**
 * @file protocol.cpp
 * @brief TWS BMS Modbus protocol implementation over serial UART.
 * @details Implements the BmsProtocol class for communicating with the TWS BMS
 *          via Modbus RTU over a serial port. Handles register read/write,
 *          CRC16 calculation, and parsing of battery status frames.
 */
